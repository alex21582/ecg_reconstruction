...
def create_labels(data_frame, colunm_name):
    label_encoder = LabelEncoder()
    data_frame[colunm_name] = label_encoder.fit_transform(data_frame[colunm_name])
    with open(f'{colunm_name}_labeling.txt', 'w') as f:
